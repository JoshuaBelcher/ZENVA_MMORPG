class UiButton extends Phaser.GameObjects.Container {
    constructor(scene, x, y, key, hoverKey, text, targetCallback) {
        super(scene, x, y);
        this.scene = scene; // the scene this container will be added too
        ...
        this.hoverKey = hoverKey; // the image that will be displayed when the player hovers over our button
    ...
    createButton(){
        ...
        // center the text inside the UI button
